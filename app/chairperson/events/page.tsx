...
export default function ChairpersonEventsPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("New event:", { eventTitle, eventDate, eventType, eventDescription })
  ...
  return (
    <PageLayout title="Department Events">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <h2 className="text-lg font-medium">Computer Science Department Events</h2>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="md:col-span-2">
          ...
          <div className="mt-6">
            <h3 className="mb-4 text-lg font-semibold">Department Events</h3>
        ...
        <div>
          ...
          <Card className="mt-6">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span>Total Department Events</span>
